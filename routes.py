...
def reservations():
    ...
    reservations = query.order_by(Reserva.fecha_checkin.desc()).paginate(
...
def create_reservation():
    ...
    if form.validate_on_submit():
        ...
        reserva = Reserva(
            ...
            codigo_promocional=form.codigo_promocional.data.upper() if form.codigo_promocional.data else None,
            descuento=descuento,
...
def edit_reservation(id):
    ...
    if form.validate_on_submit():
        ...
        reserva.codigo_promocional = form.codigo_promocional.data.upper() if form.codigo_promocional.data else None
